...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("dmenu_run -i -nb '#282a36' -nf '#d6feff' -sb '#fccffc' -sf '#282a36' -fn CourierPrimeCode:bold:pixelsize=15",
    ...
    awful.key({ modkey }, "f", function () awful.util.spawn( filemanager ) end,
        {description = "my files", group = "super"}),
    ...
    awful.key({ modkey }, "m", function () awful.util.spawn( "fadein" ) end,
        {description = "screenwriting program", group = "super"}),
    awful.key({ modkey }, "o", function () awful.util.spawn( "obsidian" ) end,
        {description = "markdown notes app", group = "super"}),
