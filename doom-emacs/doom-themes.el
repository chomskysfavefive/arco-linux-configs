...
(def-doom-theme doom-dracula
  ...
  ;; name        default   256       16
  ((bg         '("#282a35" "#262626" "black"        ))
   (bg-alt     '("#282a36" "#1c1c1c" "black"        ))
   (base0      '("#131420" "#1c1c1c" "black"        ))
   (base1      '("#282a36" "#1e1e1e" "brightblack"  ))
   (base2      '("#373844" "#2e2e2e" "brightblack"  ))
   (base3      '("#44475a" "#262626" "brightblack"  ))
   (base4      '("#707070" "#3f3f3f" "brightblack"  ))
   (base5      '("#6272a4" "#525252" "brightblack"  ))
   (base6      '("#b6b6b2" "#bbbbbb" "brightblack"  ))
   (base7      '("#ccccc7" "#cccccc" "brightblack"  ))
   (base8      '("#dddddd" "#dfdfdf" "white"        ))
   (fg         '("#eeeeee" "#ffffff" "white"        ))
   (fg-alt     '("#e2e2dc" "#bfbfbf" "brightwhite"  ))

   (grey       base4)
   (red        '("#ffd6d6" "#f79190" "red"          ))
   (orange     '("#ffb86c" "#ffbb66" "brightred"    ))
   (green      '("#d6ffda" "#90f795" "green"        ))
   (teal       '("#d6daff" "#0088cc" "brightgreen"  ))
   (yellow     '("#ffffd6" "#f0f790" "yellow"       ))
   (blue       '("#d6daff" "#90a4f7" "brightblue"   ))
   (dark-blue  '("#0189cc" "#0088cc" "blue"         ))
   (magenta    '("#f1d6ff" "#da90f7" "magenta"      ))
   (violet     '("#bd93f9" "#bb99ff" "brightmagenta"))
   (cyan       '("#90f3f7" "#d6feff" "brightcyan"   ))
   (dark-cyan  '("#d6feff" "#88eeff" "cyan"         ))
